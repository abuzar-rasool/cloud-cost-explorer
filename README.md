...
| `read_price`      | Float         | The price per 1M read operations, in US Dollars. Should be `null` if not applicable.                                                                                          | `0.0004`                         |
| `write_price`     | Float         | The price per 1M write operations, in US Dollars. Should be `null` if not applicable.                                                                                         | `0.005`                          |
